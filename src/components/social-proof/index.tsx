...
const socialProofs = [
  {
    ...
    text: `The MyMufti app is an incredible resource for learning and spiritual growth.
    It offers a comprehensive platform for accessing Islamic knowledge and engaging with expert muftis.
    Highly recommend for anyone seeking guidance and wisdom.`,
  },
  {
    name: `Umer`,
    company: `Amazon.com, Inc.`,
    image: `/images/social-2.webp`,
    text: `MyMufti app has truly exceeded my expectations.
    The user-friendly interface and access to qualified scholars make it a must-have for anyone interested in deepening their Islamic knowledge.
